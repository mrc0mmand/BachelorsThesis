...
\chapter{SSL/TLS} \label{chap:ssl_tls}
    \todo{change chapter name - no abbreviations}
...
\chapter{Continuous Integration System} \label{chap:continuous_integration}
    \todo{(!) split theoretical and implementation part}
...
\subsection{Performance and Limits} \label{ref:performance-limits}
    ...
    \todo{RFE: compile dev branch before testing}
...
\chapter {Testing Results} \label{chap:testing_results}
    Throughout the test extension process, we have found several bugs and issues
...
\todo{CVE: https://access.redhat.com/security/cve/CVE-2016-9574} \\
\todo{Beakerlib bugs} \\
\todo{Other issues (certgen, ...)}
