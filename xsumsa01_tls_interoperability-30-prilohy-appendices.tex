...
\section{Introduction}
    ...
    SSL/TLS libraries on CentOS and Fedora systems. The testing itself involves
    verification of ability to comunicate between two libraries using various
    combination of cipher suites and extensions.
...
\section{Suspension Criteria and Resumption Requirements}
    ...
    \begin{itemize}
        ...
        \item Existing issues prevent execution of the test suite
    \end{itemize}
...
\section{Remaining Test Tasks}
    ...
    (e.g. \textit{ChaCha20-Poly1305}~\footnote{https://tools.ietf.org/html/rfc7905}).
...
\section{Schedule}
    ...
    periodically and when a new version of supported system is released.
